...
<div class="max-w-md mx-auto mt-10 p-6 bg-white rounded shadow">
    ...
    <form method="POST" action="/oraganization-mvc/public/users/<?= $u['id'] ?>/update" class="space-y-4">
        ...
        <input type="password" name="password" placeholder="كلمة المرور الجديدة" class="w-full border px-3 py-2 rounded">
